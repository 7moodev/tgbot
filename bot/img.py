...
def draw(fetched):
    ...
    output_image_path = f"output_image_{time_now_in_unix}.png"  # Output file path 
    ...
    if fetched:
        ...
        """{'wallet': 'Fj7WXfswWhFgeiSrHzpFVjzbchwnqMxowvQBX5f9qUra', 'amount': 895045338.229479,
          'share_in_percent': 89.505, 'net_worth': 7730.0, 'net_worth_excluding': 744.7229156896447,
            'first_top_holding': {'address': '7FhLDYhLagEYx8mvheyWMo25ChQcM9F54TiM15Ydpump',
              'decimals': 6, 'balance': 895045338229479, 'ui_amount': 895045338.229479,
                'chain_id': 'solana', 'name': 'spider cat', 'symbol': 'scat',
                  'icon': 'https://wsrv.nl/?w=128&h=128&default=1&url=https%3A%2F%2Fipfs.io%2Fipfs%2FQmes6UqktVkh2j8nSyDiW8nLns7Kg1UTmhy7tMnz3D9ukb',
                    'logo_uri': 'https://wsrv.nl/?w=128&h=128&default=1&url=https%3A%2F%2Fipfs.io%2Fipfs%2FQmes6UqktVkh2j8nSyDiW8nLns7Kg1UTmhy7tMnz3D9ukb',
                      'price_usd': 7.80438351662518e-06, 'value_usd': 6985.277084310355},
                        'second_top_holding': {'address': 'So11111111111111111111111111111111111111111', 'decimals': 9,
                          'balance': 3253808371, 'ui_amount': 3.253808371, 'chain_id': 'solana', 'name': 'SOL',
                            'symbol': 'SOL',
                              'logo_uri': 'https://wsrv.nl/?w=128&h=128&default=1&url=https%3A%2F%2Fraw.githubusercontent.com%2Fsolana-labs%2Ftoken-list%2Fmain%2Fassets%2Fmainnet%2FSo11111111111111111111111111111111111111112%2Flogo.png',
          'price_usd': 228.93013011055416, 'value_usd': 744.8947737278403}, 'third_top_holding': None}}"""
        # wallet = fetched['wallet']
        # amount = fetched['amount']
        # share_in_percent = fetched['share_in_percent']
        # net_worth = fetched['net_worth']
        # net_worth_excluding = fetched['net_worth_excluding']
        # first_top_holding = fetched['first_top_holding']
        # second_top_holding = fetched['second_top_holding']
        # third_top_holding = fetched['third_top_holding']
        # first_top_holding_logo = first_top_holding['logo_uri']
        # first_top_holding_name = first_top_holding['name']
        # first_top_holding_symbol = first_top_holding['symbol']
        # second_top_holding_logo = second_top_holding['logo_uri']
        # second_top_holding_name = second_top_holding['name']
        # second_top_holding_symbol = second_top_holding['symbol']
        # third_top_holding_logo = third_top_holding['logo_uri']
