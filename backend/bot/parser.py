...
async def top_holders_holdings_parsed(token, limit):
    ...
    for holder in noteworthy:
        ...
        try:
            ...
            message += f"[\\#{holder['count']}\\({format_number(dollar_token_share)}\\)\\(💰 {format_number(holder['net_worth_excluding'])}\\)]{addy}  \\|\\+\\+ "
...
if __name__ == "__main__":
    ...
    {
        'count': 1,
        'wallet': 'GczJXQD9Bap8EypqDn6RCoUqQruKZVs2pkQL3fUHeuZS',
        'amount': 64657241.403556,
        'share_in_percent': 8.825,
        'net_worth': 241501.49928305144,
        'net_worth_excluding': 0.5859080368536524,
        'first_top_holding': {
            'address': '7yZFFUhq9ac7DY4WobLL539pJEUbMnQ5AGQQuuEMpump',
            'decimals': 6,
            'balance': 64657241403556,
            'uiAmount': 64657241.403556,
            'chainId': 'solana',
            'name': 'OBOT',
            'symbol': 'OBOT',
            'icon': 'https://ipfs.io/ipfs/QmeeSqjjrpQ5ht5uc21uG3j3PdVM46CkfTXUCyt23vs462',
            'logoURI': 'https://ipfs.io/ipfs/QmeeSqjjrpQ5ht5uc21uG3j3PdVM46CkfTXUCyt23vs462',
            'priceUsd': 0.011770724831974819,
            'valueUsd': 241500.91337501458
        },
        'second_top_holding': {
            ...
            'priceUsd': 198.5428990634483,
            'valueUsd': 0.5859080368521984
        },
        'third_top_holding': None
    },
    {
        'count': 2,
        'wallet': 'HQg2zWY5jQSjVE9J5M5VrU59xjKkmLSAxq1GzLcUg61h',
        'amount': 40000000,
        'share_in_percent': 5.46,
        'net_worth': 241500.91337501458,
        'net_worth_excluding': 0.0,
        'first_top_holding': {
            'address': '7yZFFUhq9ac7DY4WobLL539pJEUbMnQ5AGQQuuEMpump',
            'decimals': 6,
        ...
        'second_top_holding': None,
        'third_top_holding': None
    },
    {
        'count': 3,
        'wallet': '5PAhQiYdLBd6SVdjzBQDxUAEFyDdF5ExNPQfcscnPRj5',
        'amount': 39633333,
        'share_in_percent': 5.41,
        'net_worth': 187883424.81608614,
        'net_worth_excluding': 187641923.90271112,
        'first_top_holding': {
            'address': 'rndrizKT3MK1iimdxRdWabcF7Zg7AR5T4nud4EkHBof',
            'decimals': 8,
            'balance': 263867102430276,
            'uiAmount': 2638671.02430276,
            'chainId': 'solana',
            'name': 'Render Token',
            'symbol': 'RENDER',
            'icon': 'https://shdw-drive.genesysgo.net/5zseP54TGrcz9C8HdjZwJJsZ6f3VbP11p1abwKWGykZH/rndr.png',
            'logoURI': 'https://shdw-drive.genesysgo.net/5zseP54TGrcz9C8HdjZwJJsZ6f3VbP11p1abwKWGykZH/rndr.png',
            'priceUsd': 7.998156832298574,
            'valueUsd': 21104504.681215398
        },
        'second_top_holding': {
            'address': 'Hax9LTgsQkze1YFychnBLtFH8gYbQKtKfWKKg2SP6gdD',
            'decimals': 9,
            'balance': 30061285734549380,
            'uiAmount': 30061285.73454938,
            'chainId': 'solana',
            'name': 'TARS AI',
            'symbol': 'TAI',
            'icon': 'https://coffee-important-lizard-419.mypinata.cloud/ipfs/Qmf19J2Teszt5ZgqrzQFuWk64xvQzfZFfEEn8ntzpbz36W',
            'logoURI': 'https://coffee-important-lizard-419.mypinata.cloud/ipfs/Qmf19J2Teszt5ZgqrzQFuWk64xvQzfZFfEEn8ntzpbz36W',
            'priceUsd': 0.2927850116012065,
            'valueUsd': 8801493.892537225
        },
        'third_top_holding': {
            'address': 'DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263',
            'decimals': 5,
            'balance': 28795943538646496,
            'uiAmount': 287959435386.46497,
            'chainId': 'solana',
            'name': 'Bonk',
            'symbol': 'Bonk',
            'icon': 'https://arweave.net/hQiPZOsRZXGXBJd_82PhVdlM_hACsT_q6wqwf5cSY7I',
            'logoURI': 'https://arweave.net/hQiPZOsRZXGXBJd_82PhVdlM_hACsT_q6wqwf5cSY7I',
            'priceUsd': 3.023144642060312e-05,
            'valueUsd': 8705430.242193041
        }
    },
    # Add more dictionaries here following the same structure...
]

# Note: The above list is truncated for brevity. You should continue adding the rest of the dictionaries in the same format.
    print (type(toparse))
