...
import math
import aiohttp
from munk.backend.utils.token_utils import get_token_overview, get_top_holders
...
if __name__ == "__main__":
    print(asyncio.run(get_holding_distribution("7FhLDYhLagEYx8mvheyWMo25ChQcM9F54TiM15Ydpump")))